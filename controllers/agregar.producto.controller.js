...
formulario.addEventListener("submit", (eventoSubmit) => {
  ...
  const contenidoDrag = `
  <img class="imagen-drop-img" src="../carpeta_imagenes/Vector-imagen.svg" alt="icono agrega imagen">
  <img class="imagen-drop-img__pantalla-mobile" src="../carpeta_imagenes/Vector-imagen_mobile.svg" alt="icono agrega imagen">
  ...
  clientServices.crearProducto(nombre, precio, fileURL, categoria, descripcion)
  .then(() => {
