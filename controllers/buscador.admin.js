...
import { adminProductosController } from "./admin.productos.controller.js";
      ...
      if (evento.key === 'Enter') {
        ...
        clientServices.listaProductos().then(data => {
          data.forEach(({nombre, precio, descripcion, imagen, id, categoria}) => {
            ...
            if(validar){
              const mostrarProductoBuscado = adminProductosController.MostrarProductosAdmin(nombre, precio, descripcion, imagen, id, categoria);
